...
export const LinkedinIcon: FC<Icon> = ({ className, color }) => (
    // <!--!Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
    <svg className={`hover-icon ${className || ""}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
        <path
...
export const YoutubeIcon: FC<Icon> = ({ className, color }) => (
    // <!--!Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
    <svg className={`hover-icon ${className || ""}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
        <path
...
export const GithubIcon: FC<Icon> = ({ className, color }) => (
    //<!--!Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
    <svg className={`hover-icon ${className || ""}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        <path
...
export const EnveloppeIcon: FC<Icon> = ({ className, color }) => (
    // <!--!Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
    <svg className={`hover-icon ${className || ""}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
        <path
...
export const TwitterIcon: FC<Icon> = ({ className, color }) => (
    //<!--!Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
    <svg className={`hover-icon ${className || ""}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
        <path
